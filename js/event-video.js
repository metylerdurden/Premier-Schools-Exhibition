document.addEventListener("DOMContentLoaded", () => {
  const video = document.getElementById("eventVideoMedia");
  const toggle = document.getElementById("eventVideoMuteToggle");
  ...
  function syncButton() {
    ...
    toggle.querySelector(".event-video__mute-icon").innerHTML = video.muted ? ICON_MUTED : ICON_UNMUTED;
  }
